...
VALUES
    (1,'Computacion', NOW(), NOW()),
    (2,'Telefonia', NOW(), NOW()),
    (3,'Videojuegos', NOW(), NOW());
--
...
VALUES
    (1,'Sony','Juan Gonzalez','Pje. Della Paolera 22 Piso 15', NOW(), NOW()),
    (2,'Dell','Carlos Graggero','Ing. Butty 214 Piso 3', NOW(), NOW()),
    (3,'Samsung','Francisco Heredia','Av. Ejercito de Salvacion 311', NOW(), NOW()),
    (4,'Microsoft','Gerardo Garcia','Bulnes 518 Piso 7', NOW(), NOW());
...
VALUES
    ...
    (2,'Notebook Vaio SVN1562883',1,1,980,2,3,0, NOW(), NOW()), -- notebook/sony
    (3,'Ultrabook Slim Vaio SVUB15551',1,1,1800,1,1,0, NOW(), NOW()), -- notebook/sony
    (4,'Inspiron 14-55312',2,1,540,6,0,0, NOW(), NOW()), -- notebook/dell
    (5,'Latitude 12-24411',2,1,1100,3,0,0, NOW(), NOW()), -- notebook/dell
    (6,'Chromebook 13KBE04',3,1,880,1,3,0, NOW(), NOW()), -- notebook/samsung
    (7,'Xperia V6',1,2,660,3,1,0, NOW(), NOW()), -- cel/sony
    (8,'Xperia V9',1,2,1200,1,0,0, NOW(), NOW()), -- cel/sony
    (9,'S8',3,2,990,4,3,0, NOW(), NOW()), -- cel/samsung
    (10,'S8',3,2,990,4,3,0, NOW(), NOW()), -- cel/samsung
    (11,'S8 mini',3,2,550,8,2,0, NOW(), NOW()), -- cel/samsung
    (12,'S9',3,2,1300,3,0,0, NOW(), NOW()), -- cel/samsung
    (13,'S9 mini',3,2,670,5,2,0, NOW(), NOW()), -- cel/samsung
    (14,'Playstation 4 500 MB',4,3,700,5,3,0, NOW(), NOW()), -- vj/ms
    (15,'Playstation 4 1000 MG',4,3,1100,3,1,0, NOW(), NOW()), -- vj/ms
    (16,'Mando Playstation XV3432',4,3,150,3,0,0, NOW(), NOW()), -- vj/ms
    (17,'Xbox One',1,3,1100,4,0,0, NOW(), NOW()), -- vj/Sony
    (18,'Mando Xbox Bateria VBB133123',1,3,170,3,0,0, NOW(), NOW()); -- vj/Sony
...
VALUES
    (1, 'julespi@gmail.com', 'admin', 'Julian', 'Spinelli', null, 'MANAGER', null, NOW(), NOW()),
    (2, 'empleado@uno.com', 'empleado1', 'Empleado', 'Uno', null, 'SALESMAN', 1, NOW(), NOW()),
    (3, 'empleado@dos.com', 'empleado2', 'Empleado', 'Dos', null, 'SALESMAN', 1, NOW(), NOW()),
    (4, 'cliente@uno.com', 'cliente1', 'Cliente', 'Uno', 'Banfield', 'CLIENT', null, NOW(), NOW()),
    (5, 'cliente@dos.com', 'cliente2', 'Cliente', 'Dos', 'Mar del Plata', 'CLIENT', null, NOW(), NOW());
